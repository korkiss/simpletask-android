...
class FilterListFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val items = arguments?.getStringArrayList(FilterActivity.FILTER_ITEMS)?: ArrayList()
        ...
        if (savedInstanceState != null) {
            ...
            mSelectedItems = arguments?.getStringArrayList(FilterActivity.INITIAL_SELECTED_ITEMS) ?: ArrayList()
